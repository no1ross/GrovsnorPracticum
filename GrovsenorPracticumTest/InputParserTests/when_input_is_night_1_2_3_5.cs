...
{
    public class when_input_is_night_1_2_3_5 : given_an_input_parser
    {
        private const string input = "night, 1, 2, 3, 5";
        private const string output = "steak, potato, wine, error";
